...
path = "/Users/wx/Documents/gt/spring2017/ECE_6254_Statistics_Machine_Learning/project/"  # Insert path here
...
team_OVA = pd.read_csv("/Users/wx/Documents/gt/spring2017/ECE_6254_Statistics_Machine_Learning/project/team_ova/team_OVA.csv")
...
print(inputs.head(5))
feature_details = explore_data(features.iloc[:, :15], inputs, path)
...
parameters_RF = {'max_features': ['auto'], 'n_estimators': [800, 1000, 1500]}
